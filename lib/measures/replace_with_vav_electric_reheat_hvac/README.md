...
|---|---|---|---|---|
| Replacement selection | Proposed `PrincipalHVACSystemType`; VAV delivery, chilled-water cooling, electric terminal reheat | Consumer selects exact proposed topology | Relationship mapping | Scenario context distinguishes existing/proposed systems |
